...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'portfolio_general_homepage');
            }
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'portfolio_user_homepage');
            }

            return array (  '_controller' => 'Portfolio\\UserBundle\\Controller\\DefaultController::indexAction',  '_route' => 'portfolio_user_homepage',);
        }
